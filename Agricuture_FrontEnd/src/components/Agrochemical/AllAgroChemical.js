    ...
    <div class="d-flex justify-content-center row" >
        ...
        <Row xs={1} md={1} className="g-4" id="by" class="rounded">
            ...
            <div class="row p-2 bg-white border rounded " style={{background:"#e0e0d1",marginTop:"30px",marginLeft:"60px"}}>
                <div class="col-md-3 mt-1"><img class="img-fluid img-responsive rounded product-image" style={{padding:"10px",marginTop:"20px"}} src={`/uploads/${eq.agrochemicalImage}`}/></div>
                <div class="col-md-6 mt-1">
                    <h5>{idx + 1}. &nbsp;{eq.agrochemicalName}</h5>
