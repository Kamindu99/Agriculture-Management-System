...
const EditAgriFertilizer = (props)=>{
   ...
   const changeOnClick =(e)=>{
    ...
    if (form.checkValidity() === false) {
      ...
      e.stopPropagation();
       ...
       history.push("/admin/agrifertilizer/all");
       alert("Fertilizer Details Update Successful")
      }
      setValidated(true);
   };
   ...
   useEffect(() => {
    axios
      ...
      .then((res) =>
       [
        setName(res.data.fertilizer.fertilizerName),
        setPrice(res.data.fertilizer.price),
        setDescription(res.data.fertilizer.description)
...
export default EditAgriFertilizer;