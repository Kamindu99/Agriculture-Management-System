...
const EditAgriSeed = (props)=>{
   ...
   const changeOnClick =(e)=>{
    ...
    if (form.checkValidity() === false) {
      ...
      e.stopPropagation();
       ...
       axios
       .put(`https://agribackend.onrender.com/agriseed/admin/update/${id}`,formData)
       .then(
       ...
       history.push("/admin/agriseed/all");
       alert("Seed Details Edit Successful")
      }
      setValidated(true);
   };
   ...
   useEffect(() => {
    axios
      .get(
        `https://agribackend.onrender.com/agriseed/admin/${id}`
      )
      .then((res) =>
       [
        setName(res.data.seed.seedName),
        setPrice(res.data.seed.price),
        setDescription(res.data.seed.description)
