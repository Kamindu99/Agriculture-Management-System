...
const AddEquipment = () => {
  ...
  const changeOnClick = (e) => {
    ...
    if (form.checkValidity() === false) {
      ...
      axios
        .post("https://agribackend.onrender.com/agriequipment/admin/add", equipmentss)
        .then(
          ...
          <div className="w-75 mx-auto shadow p-5">
            ...
            <Form noValidate validated={validated} class="signup-form" onSubmit={changeOnClick} encType="multipart/form-data">
              ...
              <lable class="label-title"><b>Add an Image*</b>
                <div class="mb-3">
                  <input class="form-control" required type="text" id="formFile" name="equipmentImage" onChange={(e) => setEquipmentImage(e.target.value)} />
                  <Form.Control.Feedback type="invalid">
